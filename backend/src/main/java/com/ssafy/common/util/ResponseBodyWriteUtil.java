...
public class ResponseBodyWriteUtil {
	...
	public static void sendError(HttpServletRequest request, HttpServletResponse response, Exception ex,
	...
	public static void sendError(HttpServletRequest request, HttpServletResponse response, Exception ex) throws
		IOException {
