  ...
  const emailAuth = async (e) => {
    ...
    if (formData.email === "") {
      ...
      try {
        ...
        try {
          const resForm = await axios.get(`/api/users/${formData.email}`);
              ...
              <S.contentWrap>
                ...
                <S.inputWrap>
                  <S.inputContent
                    ...
                    menu="dup"
                  />
                  <S.CheckBtn type="button" onClick={onClickCheckId}>
                    중복 확인
                  </S.CheckBtn>
                </S.inputWrap>
                {userIdCheck && (
                ...
                <S.inputWrap>
                  <S.inputContent
                    ...
                    menu="dup"
                  />
                  <S.CheckBtn type="button" onClick={onClickVerficationCode}>
                    인증 확인
                  </S.CheckBtn>
                </S.inputWrap>
                ...
                <S.inputWrap>
                  <S.inputContent
                    ...
                    menu="dup"
                  />
                  <S.CheckBtn type="button" onClick={onClickCheckNickName}>
                    중복 확인
                  </S.CheckBtn>
                </S.inputWrap>
                {userNickNameCheck && (
                ...
                {passwordMatchError === null && <S.hidden>숨김</S.hidden>}
                <S.signupWrap>
