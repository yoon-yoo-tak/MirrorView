        ...
        <S.wrap>
          <S.profileBox>
            ...
            <S.profileInfo>
              ...
              <S.profileImage>
                <img src={user.photo} alt="profileImage" style={imageStyle} />
                ...
                <div>
                  <Menu
                    ...
                    <MenuItem onClick={handleInput} style={font}>
                      이미지 등록하기
                      <input
                        type="file"
                        style={{ display: "none" }}
                    ...
                    <MenuItem onClick={setDefaultImage} style={font}>
                      기본 이미지로 설정하기
                    </MenuItem>
                  </Menu>
                </div>
              ...
              <S.profileDetail>
                ...
                <S.profileContent>{user.email}</S.profileContent>
                <S.profileContent>{user.nickname}</S.profileContent>
              </S.profileDetail>
              <S.profileUpdate>
                <S.profileContent style={hidden}>숨김</S.profileContent>
            ...
            <S.withdrawal onClick={goWithdrawal}>회원탈퇴</S.withdrawal>
          </S.profileBox>
        </S.wrap>
      </S.page>
    </div>
