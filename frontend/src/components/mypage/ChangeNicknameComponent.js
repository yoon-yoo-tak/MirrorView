        ...
        await axios
            ...
            .then((response) => {
                ...
                Swal.fire({
                    // icon: 'error',
                    width: 400,
                    title: '<div style="font-size:20px; font-family: HakgyoansimWoojuR;font-weight:bold;">사용 가능한 닉네임입니다<div>',
                });
            ...
            .catch((error) => {
                ...
                Swal.fire({
                    icon: "error",
                    width: 400,
                    title: '<div style="font-size:20px; font-family: HakgyoansimWoojuR;font-weight:bold;">사용 불가능한 닉네임입니다<div>',
                });
                setNicknameValid(false);
            });
    };
