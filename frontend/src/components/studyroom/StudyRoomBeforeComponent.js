        ...
        <S.page>
            <S.prepareWrap>
                <S.prepareSectionFirst>
                    ...
                    <S.videoParent>
                        <S.videoMain autoPlay={true} ref={videoRef} />

                        {isVideoOn && (
                            <S.videoControlon onClick={handleCamEnable} />
                        )}
                        {!isVideoOn && (
                            <S.videoControloff onClick={handleCamEnable} />
                        )}
                    </S.videoParent>
                ...
                <S.prepareSectionSecond>
                    <PrepareSection
                        username={nickname}
                        peopleList={currentRoom.members?.filter(
