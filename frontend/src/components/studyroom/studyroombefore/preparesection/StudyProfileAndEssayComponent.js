  ...
  return (
    <div>
      <S.profileAndEssayWrap>
            ...
            <div>
              {peopleList &&
                peopleList.map((people, index) => (
                  <S.peopleName onClick={() => handleCheckWho(index)}>
                    {people.nickname}
                  </S.peopleName>
                ))}
            </div>
        ...
        <S.contentTapWrap>
          <S.contentTapList>
            <S.contentTap onClick={handleProfileTap}>프로필</S.contentTap>
            <S.contentTap onClick={handleEssayTap}>자기소개서</S.contentTap>
            <S.contentTap onClick={handleQuestionTap}>질문리스트</S.contentTap>
          </S.contentTapList>
          <S.contentDetail>
            {!checkProfile ? (
              <S.profileContent>
